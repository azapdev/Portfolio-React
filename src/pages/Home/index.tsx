...
const Home: FC = () => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[60%_45%] px-1 md:px-8 items-start justify-center lg:h-[calc(100vh-80px)] min-h-96 md:max-w-5xl md:items-center mx-auto ">
      {/* info */}
      <motion.div
